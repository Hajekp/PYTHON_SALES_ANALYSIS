...
1. **Total units sold per product category** — bar chart showing top 10 categories by quantity
...
4. **Monthly revenue 2018** — line chart showing revenue trends month by month
